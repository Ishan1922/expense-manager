...
const { getTransactionsPagination,registerUser, getTransactions, deleteTransaction, updateTransaction, addTransaction, getTransactionsOfLast30Days, getTransactionsOfLast7Days,userCheck } = require("../controllers/authController");

// Route for registering a user
router.post("/register", registerUser);
router.post("/userCheck", userCheck);
router.get("/transactions/:id", getTransactionsPagination);
